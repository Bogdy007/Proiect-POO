...
namespace EvadareBranEditor
{
    public partial class Form1 : Form
    {
        ...
        private void AfiseazaEditorAtribut(AtributPoveste attr, TreeNode nodCurent)
        {
            ...
            NumericUpDown nudMin = new NumericUpDown { Minimum = -99999, Maximum = 99999, Value = attr.Min, Location = new Point(180, y), Width = 100 };
            ...
            NumericUpDown nudMax = new NumericUpDown { Minimum = -99999, Maximum = 99999, Value = attr.Max, Location = new Point(330, y), Width = 100 };
            ...
            NumericUpDown nudInitial = new NumericUpDown { Minimum = -99999, Maximum = 99999, Value = attr.Initial, Location = new Point(180, y), Width = 100 };
